...
class ParseTreeTestCase < Test::Unit::TestCase
  ...
  add_tests("and",
            ...
            "ParseTree"   => s(:and, s(:call, nil, :a, s(:arglist)), s(:call, nil, :b, s(:arglist))))
  ...
  add_tests("argscat_inside",
            ...
            "ParseTree"   => s(:lasgn, :a,
                              s(:argscat, s(:array, s(:call, nil, :b, s(:arglist))), s(:call, nil, :c, s(:arglist)))),
            "Ruby2Ruby"   => "a = b, *c")
  ...
  add_tests("argspush",
            ...
            "ParseTree"   => s(:attrasgn,
                              ...
                              :[]=,
                              s(:argspush, s(:splat, s(:call, nil, :b, s(:arglist))), s(:call, nil, :c, s(:arglist)))))
  ...
  add_tests("attrset",
            ...
            "ParseTree"   => s(:defn, :writer=,
                               s(:args), # FIX: needs an arg, for arity
                               s(:attrset, :@writer)),
  ...
  add_tests("begin",
            ...
            "ParseTree"   => s(:begin, s(:call, s(:lit, 1), :+, s(:arglist, s(:lit, 1)))))
  ...
  add_tests("block_pass_fcall_0",
            ...
            "ParseTree"   => s(:block_pass, s(:call, nil, :b, s(:arglist)), s(:call, nil, :a, s(:arglist))))
  ...
  add_tests("break",
            ...
            "ParseTree"   => s(:iter,
                              s(:call, nil, :loop, s(:arglist)), nil, s(:if, s(:true), s(:break), nil)))
  ...
  add_tests("call_arglist",
            ...
            "ParseTree"   => s(:call, s(:call, nil, :o, s(:arglist)), :puts, s(:arglist, s(:lit, 42))))
  ...
  add_tests("case_nested_inner_no_expr",
            ...
            "ParseTree"   => s(:case, s(:call, nil, :a, s(:arglist)),
                              s(:when, s(:array, s(:call, nil, :b, s(:arglist))),
                               s(:case, nil,
                                s(:when, s(:array, s(:and, s(:call, nil, :d, s(:arglist)), s(:call, nil, :e, s(:arglist)))),
  ...
  add_tests("case_no_expr",
            ...
            "ParseTree"    => s(:case, nil,
                            s(:when,
                             s(:array, s(:call, s(:call, nil, :a, s(:arglist)), :==, s(:arglist, s(:lit, 1)))),
                             s(:lit, :a)),
                            s(:when,
                             s(:array, s(:call, s(:call, nil, :a, s(:arglist)), :==, s(:arglist, s(:lit, 2)))),
                             s(:lit, :b)),
                            s(:lit, :c)))
  ...
  add_tests("case_splat",
            ...
            "ParseTree"    => s(:case, s(:call, nil, :a, s(:arglist)),
                            s(:when,
                             s(:array, s(:lit, :b), s(:when, s(:call, nil, :c, s(:arglist)), nil)), # wtf?
                             s(:call, nil, :d, s(:arglist))),
  ...
  add_tests("class_scoped3",
            ...
            "ParseTree"    => s(:class, s(:colon3, :Y), nil, s(:scope, s(:call, nil, :c, s(:arglist)))))
  ...
  add_tests("conditional3",
            "Ruby"        => "if (42 == 0) then\n  return 3\nelse\n  return 4\nend",
            "RawParseTree"=> [:if, [:call, [:lit, 42], :==, [:array, [:lit, 0]]],
                              [:return, [:lit, 3]],
                              [:return, [:lit, 4]]],
            "ParseTree"   => s(:if, s(:call, s(:lit, 42), :==, s(:arglist, s(:lit, 0))),
                              s(:return, s(:lit, 3)),
                              s(:return, s(:lit, 4))))
  ...
  add_tests("conditional_post_if",
            ...
            "ParseTree"   => s(:if, s(:call, nil, :b, s(:arglist)), s(:call, nil, :a, s(:arglist)), nil))

  add_tests("conditional_post_if_not",
            "Ruby"        => "a if not b",
            "RawParseTree"=> [:if, [:vcall, :b], nil, [:vcall, :a]],
            "ParseTree"   => s(:if, s(:call, nil, :b, s(:arglist)), nil, s(:call, nil, :a, s(:arglist))),
  ...
  add_tests("dot2",
            ...
            "ParseTree"   => s(:dot2, s(:call, nil, :a, s(:arglist)), s(:call, nil, :b, s(:arglist))))

  add_tests("dot3",
            "Ruby"        => "(a...b)",
            "RawParseTree"=> [:dot3, [:vcall, :a], [:vcall, :b]],
            "ParseTree"   => s(:dot3, s(:call, nil, :a, s(:arglist)), s(:call, nil, :b, s(:arglist))))
  ...
  add_tests("dregx",
            ...
            "ParseTree"   => s(:dregx, "x",
                              s(:evstr, s(:call, s(:lit, 1), :+, s(:arglist, s(:lit, 1)))), s(:str, "y")))
  ...
  add_tests("dregx_n",
            ...
            "ParseTree"   => s(:dregx, '', s(:evstr, s(:lit, 1)), /x/n.options),
  ...
  add_tests("dregx_once_n_interp",
            "Ruby"        => "/#\{IAC}#\{SB}/no",
            "RawParseTree"=> [:dregx_once, '', [:evstr, [:const, :IAC]], [:evstr, [:const, :SB]], /x/n.options],
            "ParseTree"   => s(:dregx_once, '', s(:evstr, s(:const, :IAC)), s(:evstr, s(:const, :SB)), /x/n.options),
  ...
  add_tests("iteration3",
            ...
            "ParseTree"   => s(:iter,
                              ...
                              s(:dasgn_curr, :n),
                              s(:call, nil, :puts, s(:arglist, s(:call, s(:dvar, :n), :to_s, s(:arglist))))))
  ...
  add_tests("iteration_masgn",
            ...
            "RawParseTree"=> [:iter,
                              ...
                              [:masgn, [:dasgn_curr, :args]]],
            "ParseTree"   => s(:iter,
                              s(:call, nil, :define_method, s(:arglist, s(:call, nil, :method, s(:arglist)))),
                              s(:masgn, s(:dasgn_curr, :args))))
  ...
  add_tests("lasgn_call",
            ...
            "ParseTree"   => s(:lasgn, :c, s(:call, s(:lit, 2), :+, s(:arglist, s(:lit, 3)))))
  ...
  add_tests("lit_regexp_i_wwtt",
            ...
            "ParseTree"   => s(:call, s(:call, nil, :str, s(:arglist)), :split, s(:arglist, s(:lit, //i))))

  add_tests("lit_regexp_n",
            "Ruby"        => "/x/n",
            "RawParseTree"=> [:lit, /x/n],
            "ParseTree"   => s(:lit, /x/n),
            "Ruby2Ruby"   => /x/n.inspect) # HACK differs on 1.9 - this is easies
                                   ...
                                   s(:rescue,
                                    s(:resbody,
                                     ...
                                     s(:block,
                                      ...
                                      s(:call, nil, :puts, s(:arglist, s(:dvar, :b)))))))))))))
  ...
  add_tests("module_scoped3",
            ...
            "ParseTree"    => s(:module, s(:colon3, :Y), s(:scope, s(:call, nil, :c, s(:arglist)))))
  ...
  add_tests("op_asgn1",
            ...
            "ParseTree"   => s(:block,
                              s(:lasgn, :b, s(:zarray)),
                              s(:op_asgn1, s(:lvar, :b),
                               s(:array, s(:lit, 1)), :"||", s(:lit, 10)),
                              s(:op_asgn1, s(:lvar, :b),
                               s(:array, s(:lit, 2)), :"&&", s(:lit, 11)),
                              s(:op_asgn1, s(:lvar, :b),
                               s(:array, s(:lit, 3)), :+, s(:lit, 12))))
  ...
  add_tests("or",
            ...
            "ParseTree"   => s(:or, s(:call, nil, :a, s(:arglist)), s(:call, nil, :b, s(:arglist))))
...
"',
  ...
  add_tests("structure_extra_block_for_dvar_scoping",
            ...
            "ParseTree"   => s(:iter,
                              ...
                              s(:if,
                               s(:call, s(:call, nil, :e, s(:arglist)), :f, s(:arglist, s(:dvar, :c))),
                               nil,
                               s(:block,
                                s(:dasgn_curr, :g, s(:false)),
                                s(:iter,
                                 s(:call, s(:dvar, :d), :h, s(:arglist)),
            ...
            "ParseTree"   => s(:block,
                              s(:lasgn,
                               ...
                               s(:if, s(:call, nil, :c, s(:arglist)),
                                 s(:rescue, s(:call, nil, :b, s(:arglist)),
                                   s(:resbody, s(:array), s(:nil))), # TODO: check array
                                nil)),
                              s(:lvar, :a)),
  ...
  add_tests("super", # TODO: all supers need to pass args
            "Ruby"        => "def x\n  super(4)\nend",
            "RawParseTree"=> [:defn, :x,
                              [:scope,
                               [:block,
  ...
  add_tests("super_block_pass",
            ...
            "ParseTree"   => s(:block_pass,
                              s(:call, nil, :b, s(:arglist)), s(:super, s(:array, s(:call, nil, :a, s(:arglist))))))
  ...
  add_tests("super_multi",
            ...
            "ParseTree"   => s(:defn, :x,
                               s(:args),
                               s(:scope,
                                 s(:block, # TODO: super array should be arglist
                                   s(:super, s(:array, s(:lit, 4), s(:lit, 2), s(:lit, 1)))))))

  add_tests("svalue",
            "Ruby"        => "a = *b",
            "RawParseTree"=> [:lasgn, :a, [:svalue, [:splat, [:vcall, :b]]]],
            "ParseTree"   => s(:lasgn, :a, s(:svalue, s(:splat, s(:call, nil, :b, s(:arglist))))))
  ...
  add_tests("yield_args", # TODO: make yield arg more consistent and an arglist
            "Ruby"        => "yield(42, 24)",
